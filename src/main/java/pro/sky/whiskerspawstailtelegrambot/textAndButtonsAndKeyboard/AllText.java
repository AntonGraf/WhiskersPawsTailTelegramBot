...
//    public static final String ALREADY_REGISTERED = "Вы уже зарегестрированы";
  ...
  public static final String BAD_REPORT = "Дорогой усыновитель, мы заметили, что ты заполняешь отчет не так подробно, " +
  ...
  public static final String NO_REPORT = "Дорогой усыновитель, мы заметили, что ты не присылал отчет за последние два дня, " +
          "как необходимо. Пожалуйста, подойди ответственнее к этому занятию. В противном случае волонтеры приюта " +
          "будут обязаны самолично проверять условия содержания животного";
}
